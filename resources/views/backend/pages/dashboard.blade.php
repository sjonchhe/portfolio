          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 " >
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title">{{$skillcount}}
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="#pablo" class="danger-link">See all skills...</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">remove_red_eye</i> View Projects
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- <div class="row">
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Portfolio Updated</h4>
